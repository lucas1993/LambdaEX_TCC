...
Inductive L_contextual_closure (Red : pterm -> pterm -> Prop) : pterm -> pterm -> Prop :=
  | L_redex : forall t s, Lterm t -> Lterm s -> Red t s -> L_contextual_closure Red t s
...
| ESlab_sub_left : forall t t' u L, (forall x, x \notin L -> ESlab_contextual_closure Red (t^x) (t'^x)) -> 
	                              term u -> ESlab_contextual_closure Red  (pterm_sub t u) (pterm_sub t' u)
| ESlab_sub_right : forall t u u', ESlab_contextual_closure Red u u' -> term t ->
	  	                     ESlab_contextual_closure Red  (pterm_sub t u) (pterm_sub t u')
| ESlab_lsub_left : forall t t' u L, (forall x, x \notin L -> ESlab_contextual_closure Red (t^x) (t'^x)) -> 
	                               term u -> ESlab_contextual_closure Red  (pterm_lsub t u) (pterm_lsub t' u)
| ESlab_lsub_right : forall t u u', ESlab_contextual_closure Red u u' -> term t -> 
	  	                      ESlab_contextual_closure Red  (pterm_lsub t u) (pterm_lsub t u').
*)
...
| L_p_redex : forall t s, Lterm t -> Lterm s -> Red t s -> L_p_contextual_closure Red t s
...
Inductive ES_p_contextual_closure (Red : pterm -> pterm -> Prop) : pterm -> pterm -> Prop :=
  | ES_p_redex : forall t s, term t -> term s -> Red t s -> ES_p_contextual_closure Red t s
  ...
  | ES_p_sub : forall t t' u u' L, (forall x, x \notin L -> ES_p_contextual_closure Red (t^x) (t'^x)) -> 
...
*)
Hint Constructors L_contextual_closure ES_contextual_closure L_p_contextual_closure ES_p_contextual_closure.
(* ESlab_contextual_closure ESlab_p_contextual_closure. *)
...
Inductive trans_closure (Red : pterm -> pterm -> Prop) : pterm -> pterm -> Prop :=
  ...
  | transitive_reduction : forall t u v, trans_closure Red t u -> trans_closure Red u v -> trans_closure Red t v.
...
Proof. 
 ...
 forwards~ H: (one_step_reduction t u).
 induction H1. apply star_trans_reduction.
...
Proof.
  ...
  apply star_trans_reduction.
  apply transitive_reduction with t0; trivial.
Qed.
...
Proof.
  intros_all. induction H. 
  exists u. split; trivial. apply reflexive_reduction.
